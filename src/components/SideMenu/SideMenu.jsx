              ...
              <ul class="staffList mb-5">
                ...
                loggedInUser.level ? (
                  <div>
                    ...
                    <li className="mb-4  ">
                      <a href="/testChoice">
                        <span class="fas fa-pen  mr-3"></span> Take tests or
                        exams
                      </a>
                    </li>
                    <li className="mb-4  ">
                  ...
                  <div>
                    ...
                    <li className=" mb-4 ">
                      <a href="/studentsPerformance">
                        <i class="    "></i>
                        <span class="fas fa-user-graduate  mr-3"></span>{' '}
                  ...
                  <div>
                    ...
                    <li className="mb-4">
                      <a href="/notifications">
                        <span className="fas fa-bell mr-3   "></span>{' '}
                        Notifications
                      </a>
                    </li>
                    <li className="mb-4">
                ...
                {loggedInUser && loggedInUser.role === 'store admin' ? (
                  <div>
                    <li className="mb-4">
                      <a href="/addStoreItem">
                        <span className="fas fa-cart-plus mr-3   "></span> Add a
                        new store item
                      </a>
                    </li>
                    <li className="mb-4">
